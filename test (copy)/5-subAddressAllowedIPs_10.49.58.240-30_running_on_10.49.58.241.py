...
't27':{'casename':'MX-11376','receivers':['u1 <test----u1@openwave.com>','u3 <test----u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to test-- folder'},
't28':{'casename':'MX-11377','receivers':['u1 <Trash----u1@openwave.com>','u3 <Trash----u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to Trash-- folder'},
...
't30':{'casename':'MX-11379','receivers':['u1 <test\'---u1@openwave.com>','u3 <test\'---u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to test'- folder"},
't31':{'casename':'MX-11380','receivers':[r'u1 <"te st---u1@openwave.com">',r'u3 <"te st---u3">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to te st- folder'},
't32':{'casename':'MX-11381','receivers':[r'u1 <"te\"st---u1@openwave.com">',r'u3 <"te\"st---u3">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to te"st- folder'},
...
't38':{'casename':'MX-11387','receivers':['u1+++ <test\'---u1@openwave.com>','u3+++ <test\'---u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to test'- folder"},
            }
