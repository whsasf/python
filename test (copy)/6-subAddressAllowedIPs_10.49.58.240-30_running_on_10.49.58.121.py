...
't27':{'casename':'MX-11414','receivers':['u1 <test----u1@openwave.com>','u3 <test----u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
't28':{'casename':'MX-11415','receivers':['u1 <Trash----u1@openwave.com>','u3 <Trash----u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
...
't30':{'casename':'MX-11417','receivers':['u1 <test\'---u1@openwave.com>','u3 <test\'---u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
't31':{'casename':'MX-11418','receivers':[r'u1 <"te st---u1@openwave.com">',r'u3 <"te st---u3">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
't32':{'casename':'MX-11419','receivers':[r'u1 <"te\"st---u1@openwave.com">',r'u3 <"te\"st---u3">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
...
't38':{'casename':'MX-11425','receivers':['u1+++ <test\'---u1@openwave.com>','u3+++ <test\'---u3>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered:'},
	          }
