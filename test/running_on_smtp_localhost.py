...
testcases = {
't1':{'casename':'MX-11124','receivers':['u1 <u1+Trash@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to Trash'},
't1':{'casename':'MX-11124','receivers':['u1 <u1++++Trash@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to +++Trash'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+--Trash@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to --Trash'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+----Trash@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to ----Trash'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+!Trash@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to !Trash'},
't1':{'casename':'MX-11124','receivers':["u1 <u1+Trash'@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to Trash'"},
't1':{'casename':'MX-11124','receivers':["u1 <u1+Tras h@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to Tras h"},
't1':{'casename':'MX-11124','receivers':['u1 <Trash--u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to Trash'},
't1':{'casename':'MX-11124','receivers':['u1 <Trash-----u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to Trash---'},
't1':{'casename':'MX-11124','receivers':['u1 <!Trash--u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to !Trash'},
't1':{'casename':'MX-11124','receivers':["u1 <Trash'--u1@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to Trash'"},
't1':{'casename':'MX-11124','receivers':["u1 <Tras h--u1@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to Tras h"},
't1':{'casename':'MX-11124','receivers':['u1 <u1+test@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to test'},
't1':{'casename':'MX-11124','receivers':['u1 <u1++++test@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to +++test'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+--test@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to --test'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+----test@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to ----test'},
't1':{'casename':'MX-11124','receivers':['u1 <u1+!test@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to !test'},
't1':{'casename':'MX-11124','receivers':["u1 <u1+test'@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to test'"},
't1':{'casename':'MX-11124','receivers':["u1 <u1+tes t@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to tes t"},
't1':{'casename':'MX-11124','receivers':['u1 <test--u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to test'},
't1':{'casename':'MX-11124','receivers':['u1 <test-----u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to test---'},
't1':{'casename':'MX-11124','receivers':['u1 <!test--u1@openwave.com>'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to !test'},
't1':{'casename':'MX-11124','receivers':["u1 <test'--u1@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to test'"},
't1':{'casename':'MX-11124','receivers':["u1 <tes t--u1@openwave.com>"],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':"delivered to tes t"},
            }
