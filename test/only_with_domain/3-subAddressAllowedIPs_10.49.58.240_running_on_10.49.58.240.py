...
't31':{'casename':'MX-11304','receivers':[r'u1 <"te st---u1@openwave.com">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to te st-'},
't32':{'casename':'MX-11305','receivers':[r'u1 <"te\"st---u1@openwave.com">'],'commands':'su - imail -c "cat log/mta.log;> log/mta.log"','check_flags':'delivered to te"st-'},
